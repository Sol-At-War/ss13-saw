...
/datum/mood_event/lean/add_effects(mob/living/lean_monster)
	var/list/messages = list("Uh, fuckin' hoes that ain't worth a cent", "In homes that ain't worth the rent", "Yuh, ooh, brr, brr", "Gucci gang, ooh", "Yuh, Lil Chungus, yuh", "Okay, let's get it now", "Fake lies to real", "These hoes ain't loyal.", "I hate that [lean_monster.real_name] kid.")
